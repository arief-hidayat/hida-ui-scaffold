...
<div class="row" style="margin-left: 0px">
    <g:form url="[resource:employeeType, action:'delete']" method="DELETE">
        <g:hiddenField name="version" value="${employeeType?.version}"/>
        <g:hiddenField name="id" value="${employeeType?.id}"/>
        <fieldset class="form">
